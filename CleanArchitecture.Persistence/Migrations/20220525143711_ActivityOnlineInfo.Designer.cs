...
namespace CleanArchitecture.Persistence.Migrations
{
    ...
    [Migration("20220525143711_ActivityOnlineInfo")]
    partial class ActivityOnlineInfo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.CommissionStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Contract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Order", b =>
                {
                    ...
                    b.Property<bool>("UserVisibilityStatus")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.ProfileCommentReports", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("UserProfileCommentId")
                        .HasColumnType("char(36)");

                    b.HasKey("Id");

                    b.HasIndex("UserProfileCommentId");

                    b.ToTable("ProfileCommentReports");
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.SubMerchant", b =>
                {
                    ...
                    b.Property<Guid?>("CommissionStatusId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.UserSellContract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.ActivityJoinDetails", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Activity", null)
                        .WithOne("ActivityJoinDetails")
                        .HasForeignKey("CleanArchitecture.Domain.ActivityJoinDetails", "ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.ProfileCommentReports", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.UserProfileComment", null)
                        .WithMany("Reports")
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.SubMerchant", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.CommissionStatus", "CommissionStatus")
