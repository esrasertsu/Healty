...
const TextInput:React.FC<IProps> = ({input, width, type, maxLength, placeholder,labelName, disabled=false , label, meta:{ touched, error}}) => {
    ...
    return (
        <Form.Field  type={type} width={width}>
            ...
            <input {...input} placeholder={placeholder} maxLength={maxLength}  disabled={disabled} />
            {touched && error && (
